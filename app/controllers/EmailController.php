...
class EmailController {
    ...
    public function __construct() {
        ...
        $this->emailService = new EmailService(new Email($db));
    }
    public function sendEmail() {
        ...
        $result = $this->emailService->sendEmailWithTemplate($user_id, $email_account_id, $name, $recipientEmail, $subject, $htmlTemplate);
